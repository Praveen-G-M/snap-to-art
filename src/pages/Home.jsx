...
<nav className="sticky top-0 z-50 bg-white border-b shadow-md">
  <div className="max-w-7xl mx-auto px-4 flex items-center justify-between h-16">
    ...
    <div className="hidden md:flex gap-2">
      <button className="bg-blue-900 hover:bg-blue-700 text-white font-bold py-1 px-3 rounded" onClick={() => navigate("/login")}
>
        Sign In
      </button>
  ...
  {menuOpen && (
    <div className="md:hidden bg-white border-t px-4 py-3 space-y-3">
      ...
      <div className="pt-3 border-t flex flex-col gap-2">
        <button onClick={() => navigate("/login")}
 className="bg-blue-900 text-white font-bold py-2 rounded">
          Sign In
        </button>
        <button  onClick={() => navigate("/login")}
 className="bg-gray-100 text-blue-900 font-bold py-2 rounded">
          Get Started
        </button>
      </div>
    </div>
      ...
      <section className="relative min-h-screen flex items-center px-4 sm:px-10">
        ...
        <div className="relative z-10 h-full flex items-center text-white px-4 sm:px-25">
          <div class="border-1 p-6 rounded-2xl inset-0 bg-black/15 transition-transform duration-300 ease-out 
            ...
            <button onClick={() => navigate("/login")}
 className="bg-purple-500 text-white  px-6 py-3 rounded hover:bg-purple-600 border-1">
              ORDER NOW
            </button>
            <br /><br />
